...
### Self Check
- Did you use all three methods of adding CSS to an HTML file? yeah , i managed to used the 3 methods, the external, internal and inline
- Did you properly link the external CSS file in the HTML file?  yap, using the link tag, with the rel (attribute) and href (attribute)
